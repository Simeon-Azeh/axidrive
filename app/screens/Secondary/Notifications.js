...
const notificationsData = [
    { id: '1', type: 'file-text', content: 'Your health insurance claim has been approved.', description: 'Click here to view the claim details.', unread: true },
    { id: '2', type: 'calendar', content: 'Your next health check-up is scheduled for tomorrow.', description: 'Click here to view the appointment details.', unread: false },
    { id: '3', type: 'check-circle', content: 'Your monthly premium payment was successful.', description: 'Click here to view your payment history.', unread: true },
    { id: '4', type: 'alert-triangle', content: 'Policy renewal due soon.', description: 'Click here to renew your health insurance policy before it expires.', unread: true },
    { id: '5', type: 'alert-circle', content: 'New health insurance plan available.', description: 'Click here to explore the new plan and its benefits.', unread: false },
    { id: '6', type: 'info', content: 'Your lab results are ready.', description: 'Click here to review your lab results.', unread: false },
