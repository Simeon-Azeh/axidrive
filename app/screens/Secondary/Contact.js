      ...
      <View style={styles.content}>
        ...
        <View style={styles.contactContainer}>
          ...
          <View style={styles.contactItem}>
            ...
            <Text style={styles.contactText}>support@axk.com</Text>
          </View>
          <View style={styles.contactItem}>
        ...
        <View style={styles.socialContainer}>
          ...
          <View style={styles.socialIcons}>
            <TouchableOpacity onPress={() => openLink('https://facebook.com')}>
              <Entypo name="facebook-with-circle" size={35} color="#15868c" />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => openLink('https://twitter.com')}>
              <Entypo name="twitter-with-circle" size={35} color="#15868c" />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => openLink('https://instagram.com')}>
              <Entypo name="instagram-with-circle" size={35} color="#15868c" />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => openLink('https://linkedin.com')}>
              <Entypo name="linkedin-with-circle" size={35} color="#15868c" />
            </TouchableOpacity>
          </View>
        </View>
      </View>
