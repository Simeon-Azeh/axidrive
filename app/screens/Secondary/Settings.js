...
function ProfileTab() {
  return (
    <View style={{ paddingHorizontal: 20 }}>
      ...
      <TextInput placeholder="Member ID" style={[styles.input, { height: screenHeight * 0.08 }]} multiline value="AXK-12SADBN4" />
    ...
    <View style={{ paddingHorizontal: 20 }}>
      ...
      <View>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <Text style={{ fontFamily: 'Poppins', color: Colors.SECONDARY }}>Claim Status Updates</Text>
          <Switch value={true} trackColor={{ false: Colors.GRAY, true: '#9835ff' }} thumbColor='#9835ff' />
        </View>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <Text style={{ fontFamily: 'Poppins', color: Colors.SECONDARY }}>Policy Renewal Reminders</Text>
...
function SecurityTab({ twoFactorAuth, setTwoFactorAuth }) {
  ...
  return (
    <View style={{ paddingHorizontal: 20 }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
        <Text style={{ fontFamily: 'Poppins', color: Colors.SECONDARY }}>Notify me of attempted logins</Text>
        <Switch value={false} trackColor={{ false: Colors.GRAY, true: '#9835ff' }} thumbColor={Colors.GRAY} />
      </View>
  ...
  return (
    <View style={{ paddingHorizontal: 20 }}>
      ...
      <View style={{ marginVertical: 20 }}>
        <PlanCard name="Free" price="$260/Trim" description="Basic access" active />
        <PlanCard name="Standard" price="$600/Trim" description="Standard features" />
        <PlanCard name="Family" price="$1500/Trim" description="Family plan, covers upto 6 members" />
      </View>
      <View style={styles.row}>
      ...
      <View style={styles.billingHistory}>
        ...
        <View style={styles.billingRow}>
          ...
          <Text style={{ fontFamily: 'Poppins', color: Colors.SECONDARY }}>2ND Trim</Text>
          <Text style={{ fontFamily: 'Poppins', color: Colors.SECONDARY }}>$699</Text>
          <TouchableOpacity >
