...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#14614E', // Set the background to white
  ...
  progressBarFill: {
    height: '100%',
    backgroundColor: Colors.WHITE, // Dark fill color for contrast
  },
  loadingText: {
    fontSize: screenWidth * 0.03, // Smaller font size
    color: Colors.WHITE, // Match the text color with the progress bar fill
